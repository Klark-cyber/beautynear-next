...
export const PropertyCard = (props: PropertyCardProps) => {
	...
	/** HANDLERS **/
	const pushEditProperty = async (id: string) => { //Propertyga tegishli qismlarni ozgartirish uchun ishlatiladigan handler
	...
	if (device === 'mobile') {
		...
		return (
			<Stack className="property-card-box">
				...
				{!memberPage && property.propertyStatus === PropertyStatus.ACTIVE && ( //Ushbu buttonlar property status active bolsa korinadi,Agar property status sold bolsa korinmasligi kerak sababi sotilgan propertylarni edit qilish yoki deletega otkzish imkoni bolmasligi kerak
					<Stack className="action-box">
						<IconButton className="icon-button" onClick={() => pushEditProperty(property._id)}> {/*Propertyga tegishli qismlarni ozgartiramiz*/}
							<ModeIcon className="buttons" />
						</IconButton>
						<IconButton className="icon-button" onClick={() => deletePropertyHandler(property._id)}> {/* MyProperties ichida hosil bolgan va props orqali bu yerga kelgan deletePropertyHandlerni ishlatamiz*/}
