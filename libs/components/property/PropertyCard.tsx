	...
	if (device === 'mobile') {
		...
		return (
			<Stack className="card-config">
				<Stack className="top">
					<Link //Tanlangan property ustiga bosilganda property detail pagega ayni osha propertyni yonaltiradi
						href={{
							pathname: '/property/detail',
							query: { id: property?._id }, //query kerakli property idsini tanlab property detailga idni joylan beradi
						}}
					>
