...
// Homepage layout — Top + main content (no banner header) + Footer
			...
			return (
				<>
					<Head>
						...
						<meta name="description" content="Discover premium Korean salons and skincare clinics near you." />
...
const MobileBottomNav = () => {
	...
	return (
		...
		>
			{tabs.map((tab) => {
				const isActive = router.pathname === tab.href || router.asPath === tab.href ||
