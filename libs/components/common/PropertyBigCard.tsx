...
interface PropertyBigCardProps {
	property: Property;
	likePropertyHandler?: any; //likePropertyHandler optional boladi yani u props ichida bolishi ham bolmasligi ham mumkin
}
	...
	if (device === 'mobile') {
		...
		return (
			<Stack className="property-big-card-box" onClick={() => goPropertyDetatilPage(property?._id)}>
				...
				>
					{property && property?.propertyRank >= topPropertyRank && ( //Agar property mavjud bolsa va uning ichidagi rank 50 dan yuqori bolsa osha propertyga top maqomini beramiz
