...
interface CommunityCardProps { //kirib keladigan props uchun interface
...
const CommunityCard = (props: CommunityCardProps) => {
	const { boardArticle, size = 'normal', likeArticleHandler } = props; //size ga default normal beramiz.article sizedan kelib chiqib article cardni shakllantiramiz
	...
	if (device === 'mobile') {
		...
		return (
			<Stack
				sx={{ width: size === 'small' ? '285px' : '317px' }} //agar articli hajmi small bolsa 285 px widthni oladi.Aks holda 317
